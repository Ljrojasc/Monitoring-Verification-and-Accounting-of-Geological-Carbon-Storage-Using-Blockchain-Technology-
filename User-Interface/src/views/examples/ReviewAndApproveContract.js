...
const ReviewAndApproveContract = (props) => {
  ...
  const approveContract = () => {
    ...
    dispatch(
      ...
      .then(() => {
        addToast(`The transaction was approved successfully`, {
          appearance: 'success',
          autoDismiss: true,
        });
      })
            ...
            <>
              <Card className='bg-secondary px-md-2'>
                <ModalBody>
                    ...
                    <Card className='py-4 px-md-4'>
                      ...
                      <FormGroup row>
                        ...
                        <Col sm={9}>
                          ...
                          />
                          {/* This is to make the field required, I removed it*/}
                      ...
                      <FormGroup row>
                        ...
                        <Col sm={9}>
                          <Input
                            ...
                            placeholder='Enter status: approved, rejected, other'
                          />
                          <FormFeedback>*Required</FormFeedback>
                        </Col>
                      </FormGroup>
                    ...
                    <Card className='py-4 px-md-4'>
                      ...
                      {/*<FormGroup row>
                        ...
                        <Col sm={8}>
                         ...
                         <FormGroup row>
                        <Col sm={3}>
                          <Label>Date when the transaction was submitted</Label>
                        </Col>
                        <Col sm={1}>
                          <Label>:</Label>
                        </Col>
                      ...
                      <FormGroup row>
                        <Col sm={3}>
                          <Label>Transaction File (off chain)</Label>
                        </Col>
                        <Col sm={1}>
                          <Label>:</Label>
                        </Col>
                  ...
                  <div>
                    {/* <Label >Tx Journey :</Label> */}
                    <Card
                      className='bg-secondary shadow'
                      title='Transaction Journey'
                      style={{ background: 'rgb(230, 230, 230)' }}
                    >
                      {console.log('Transaction details are', contractDetails)}
                      {/* <CardTitle>Tx Journey</CardTitle> */}
                      <CardHeader className='border-0'>
                        <h3 className='mb-0'>Transaction Journey</h3>
                      </CardHeader>
                      <VerticalTimeline>
                        {approvals?.map((step) => (
                          <VerticalTimelineElement
