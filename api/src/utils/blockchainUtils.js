...
const getAffiliation = async (org) => {
  if (org === 'org1') {
    ...
    return 'org3'; // This is the new line 
  }
  else if (org === 'org4') {
    return 'org4'; // This is the new line 
  }
  else if (org === 'org5') {
    return 'org5'; // This is the new line 
  }
  else if (org === 'org6') {
    return 'org6'; // This is the new line 
  }
  // Optional: Add a default case to handle unexpected organization names.
  throw new Error(`Affiliation for organization ${org} not defined. Please add it to getAffiliation function.`);
};
