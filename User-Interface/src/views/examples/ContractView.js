      ...
      {contractDetails ? (
        <Modal isOpen={modal} toggle={toggle} className={className} size="lg">
          <ModalHeader className="border-0" toggle={toggle} bsSize='lg'>
            <h3 className="mb-0">Transaction Details</h3> </ModalHeader>
          ...
          <Card className="bg-secondary px-md-2">
            <ModalBody >
              ...
              <FormGroup row>
                <Col sm={3}>
                  <Label >Organization that sent the transaction</Label>
                </Col>
                <Col sm={1}>
                  <Label >:</Label>
                </Col>
                <Col sm={8}>
                  <Label for="exampleEmail" >{contractDetails.orgId}</Label>
                </Col>
              </FormGroup>
              ...
              <FormGroup row>
                ...
                <Col sm={8}>
                 ...
                 {/*<FormGroup row>
                <Col sm={3}>
                  <Label >Transaction File Name</Label>
                </Col>
                <Col sm={1}>
                  <Label >:</Label>
                </Col>
