          ...
          <div className="col">
            ...
            <Card className="shadow">
              <CardHeader className="border-0">
                ...
                <FormGroup row>
                  <Col sm={5}>
                    <Input invalid={isValidating && contractId == ''} onChange={e => { inputChangeHandler(e.target.value, 'id') }} placeholder="Enter Transaction ID " />
                        ...
                        <div>
                          <Card className="py-4 px-md-4">
                            ...
                            <FormGroup row>
                              ...
                              <Col sm={9}>
                                <Label>{contract.dateFormat}</Label>
                              </Col>
                            </FormGroup>*/}
                                ...
                                <Card className="py-4 px-md-4">
                                  ...
                                  <FormGroup row>
                                   ...
                                   {/*<FormGroup row>
                                    ...
                                    <Col sm={8}>
                                      <Label for="exampleEmail" >{contract.email}</Label>
                                    </Col>
                                  </FormGroup>*/}
                                  ...
                                  <FormGroup row>
                                    <Col sm={3}>
                                      <Label >Date the transaction was sent</Label>
                                    </Col>
                                    <Col sm={1}>
                                      <Label >:</Label>
                                    </Col>
